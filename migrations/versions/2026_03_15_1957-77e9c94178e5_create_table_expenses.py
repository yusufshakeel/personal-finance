...
def downgrade() -> None:
    ...
    op.drop_constraint("ck_expenses_cent_amount_positive", "expenses", type_="check")
    ...
    op.drop_constraint("fk_currency_code_expenses", "expenses", type_="foreignkey")
